class PhoneNumber extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhoneNumber', createEmptyInstance: create)
    ..aQS(1, _omitFieldNames ? '' : 'number', presence: $pb.FieldPresence.legacyRequired)
    ..e<PhoneNumber_PhoneType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: PhoneNumber_PhoneType.MOBILE, valueOf: PhoneNumber_PhoneType.valueOf, enumValues: PhoneNumber_PhoneType.valuesWithAliases, valueByName: PhoneNumber_PhoneType.valueByName)
