...
void main() {
  group('ExtensionRegistry', () {
    test('can track extensions from proto files', () {
      ...
      final fieldExt = registry.getExtension('google.protobuf.FieldOptions', 1000);
      ...
      final msgExt = registry.getExtension('google.protobuf.MessageOptions', 1001);
      ...
      expect(registry.getExtension('google.protobuf.FieldOptions', 9999), isNull);
    });
    ...
    test('handles nested extensions', () {
      ...
      final nestedExt = registry.getExtension('google.protobuf.FieldOptions', 2000);
    ...
    test('handles multiple proto files', () {
      ...
      expect(registry.getExtension('google.protobuf.FieldOptions', 3000), isNotNull);
      expect(registry.getExtension('google.protobuf.FieldOptions', 3001), isNotNull);
    });
  });
