...
class ExtensionValueDecoder {
  ...
  Map<ExtensionDefinition, dynamic>? _extractExtensions(
      UnknownFieldSet unknownFields, String extendeeType) {
  ...
  dynamic _decodeExtensionValue(UnknownFieldSetField field, 
    ...
    switch (extensionDef.type) {
      ...
      case FieldDescriptorProto_Type.TYPE_BYTES:
        return field.lengthDelimited.isNotEmpty ? field.lengthDelimited.first : null;
